...
export interface NotificationJobData {
    ...
    actorId?: string; // <-- ID of the user who triggered the event (Optional)
  }
...
export class NotificationsService {
  ...
  async sendNotificationToTeam(teamId: string, title: string, message: string, actorId?: string): Promise<void> {
    this.logger.log(`Queueing notification for Team ID: ${teamId} (actor: ${actorId || 'N/A'}) - Title: ${title}`);
